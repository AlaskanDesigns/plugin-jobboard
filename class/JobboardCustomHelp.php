...
class JobboardCustomHelp
{
    ...
    {
        echo '<p>' . __("Here you can view a profile of the applicant, view or download his/her CV, view emails sent, add notes, add tags to classify applicants, rate profile and change applicant’s status (active, interviewed, hired or rejected).", 'jobboard') . '</p>';
    }
